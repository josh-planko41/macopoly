...
const properties = [
    ...
    {index : 8, name : "Wallace Hall", color : "#6EA8DC", price : 100, baseRent: 6, owner: null},
    {index : 9, name : "30 Mac", color : "#6EA8DC", price : 120, baseRent: 8, owner: null},

    // right column of properties, top -> bottom
    {index : 10, name : "Duprison + Just Visiting", color : "white"},
    {index : 11, name : "Kirk Hall", color : "#C27BA0", price : 140, baseRent: 10, owner: null},
    {index : 12, name : "Facilities", color : "black", price : 150, owner: null},
    {index : 13, name : "George Draper Dayton Hall", color : "#C27BA0", price : 140, baseRent: 10, owner: null},
    {index : 14, name : "Grand Cambridge Apartments", color : "#C27BA0", price : 160, baseRent: 12, owner: null},
    {index : 15, name : "A Line", color : "gray", price : 200, owner: null},
    {index : 16, name : "Humanities", color : "#F7B16B", price : 180, baseRent: 14, owner: null},
    {index : 17, name : "Community Chest", color : "white"},
    {index : 18, name : "Weyerhaeuser Hall (Adimission Office)",color : "#F7B16B", price : 180, baseRent: 16, owner: null},
    {index : 19, name : "Carnegie Hall", color : "#F7B16B", price : 200, baseRent: 18, owner: null},
    
    // bottom row of properties, right -> left
    {index : 20, name : "Free Parking", color : "white"},
    {index : 21, name : "Hayden Courts", color : "red", price : 220, baseRent: 18, owner: null},
    {index : 22, name : "Chance", color : "white"},
    {index : 23, name : "Nicholson Field", color : "red", price : 220, baseRent: 18, owner: null},
    {index : 24, name : "Macalester Stadium", color : "red", price : 240, baseRent: 20, owner: null},
    {index : 25, name : "B Line", color : "gray", price : 200, owner: null},
    {index : 26, name : "President's Home", color : "#FFFF00", price : 260, baseRent: 22, owner: null},
    {index : 27, name : "Memorial Chapel", color : "#FFFF00", price : 260, baseRent: 22, owner: null},
    {index : 28, name : "Public Safety", color : "black", price : 150, owner: null},
    {index : 29, name : "Old Main", color : "#FFFF00", price : 280, baseRent: 24, owner: null},

    // left column of properties, bottom -> top
    {index : 30, name : "Go To Duprison", color : "white"},
    {index : 31, name : "Dewitt Wallace Library", color : "#92C47D", price : 300, baseRent: 26, owner: null},
    {index : 32, name : "Olin-Rice Science Center", color : "#92C47D", price : 300, baseRent: 26, owner: null},
    {index : 33, name : "Community Chest", color : "white"},
    {index : 34, name : "Campus Center", color : "#92C47D", price : 320, baseRent: 28, owner: null},
